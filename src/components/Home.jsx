        ...
        <div className="h-screen w-10/12 flex justify-center items-center md:justify-center md:items-center">
          <div className="flex flex-col-reverse md:flex-row justify-center md:justify-around items-center h-screen w-full">
            <div className="pt-4 mb-20 md:m-0 md:ml-4 flex flex-col basis-1/2 md:basis-2/6 lg:basis-1/2">
              ...
              <h1 className="font-secondary dark:font-darkSecondary text-center md:text-left text-5xl sm:text-5xl md:text-6xl xl:text-7xl pb-2 pt-0 md:pb-4 md:pt-2">
                Jackson McGillivary.
              </h1>
              <motion.div className="flex justify-center sm:flex sm:justify-center md:flex md:justify-start md:relative ">
                <p className="font-serif w-9/12 sm:w-7/12 md:w-[20rem] text-center md:text-left text-xl sm:text-2xl md:text-2xl xl:text-3xl">
